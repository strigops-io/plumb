...
def main():
    ...
    parser.add_argument('--log', default=str(Path(__file__).resolve().parents[2] / 'checkpoint004-merge-concurrency.log'))
    parser.add_argument('--summary', default=str(Path(__file__).resolve().parents[2] / 'checkpoint004-merge-concurrency-summary.json'))
